...
import './SynthesizerTechNote.css';
...
export default function SynthesizerTechNote() {
  return (
    <main className="tech-note-page synthesizer-tech-note">
      <header className="tech-note-hero">
        <p className="tech-note-eyebrow">TechNote（技術解説）</p>
        <h1>TechNote</h1>
        <p className="tech-note-work-title">Synthesizer（シンセサイザー）</p>
