...
import './MerkabaVectorEquilibriumTechNote.css';
...
export default function MerkabaVectorEquilibriumTechNote() {
  return (
    <main className="tech-note-page merkaba-vector-equilibrium-tech-note">
      <header className="tech-note-hero">
        <p className="tech-note-eyebrow">TechNote（技術解説）</p>
        <h1>TechNote</h1>
        <p className="tech-note-work-title">Merkaba & Vector Equilibrium（マカバとベクトル平衡体）</p>
