...
import './PlatonicSolidsTechNote.css';
...
export default function PlatonicSolidsTechNote() {
  return (
    <main className="tech-note-page platonic-solids-tech-note">
      <header className="tech-note-hero">
        <p className="tech-note-eyebrow">TechNote（技術解説）</p>
        <h1>TechNote</h1>
        <p className="tech-note-work-title">Platonic Solids（プラトン立体）</p>
