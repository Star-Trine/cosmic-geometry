...
import './CircleSystem27720TechNote.css';
...
export default function CircleSystem27720TechNote() {
  return (
    <main className="tech-note-page circle-system-27720-tech-note">
      <header className="tech-note-hero">
        <p className="tech-note-eyebrow">TechNote（技術解説）</p>
        <h1>TechNote</h1>
        <p className="tech-note-work-title">27720 Circle System（27720円体系）</p>
