...
export default function ZeroPointTechNote() {
  return (
    <main className="tech-note-page zero-point-tech-note">
      <header className="tech-note-hero">
        <p className="tech-note-eyebrow">TechNote（技術解説）</p>
        <h1>TechNote</h1>
        <p className="tech-note-work-title">Zero Point（ゼロ・ポイント）</p>
