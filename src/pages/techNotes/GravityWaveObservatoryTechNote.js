...
import './GravityWaveObservatoryTechNote.css';
...
export default function GravityWaveObservatoryTechNote() {
  return (
    <main className="tech-note-page gravity-wave-observatory-tech-note">
      <header className="tech-note-hero">
        <p className="tech-note-eyebrow">TechNote（技術解説）</p>
        <h1>TechNote</h1>
        <p className="tech-note-work-title">Gravity Wave Observatory（重力波観測所）</p>
