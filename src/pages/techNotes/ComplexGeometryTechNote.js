...
import './ComplexGeometryTechNote.css';
...
export default function ComplexGeometryTechNote() {
  return (
    <main className="tech-note-page complex-geometry-tech-note">
      <header className="tech-note-hero">
        <p className="tech-note-eyebrow">TechNote（技術解説）</p>
        <h1>TechNote</h1>
        <p className="tech-note-work-title">Complex Geometry（複素幾何学）</p>
