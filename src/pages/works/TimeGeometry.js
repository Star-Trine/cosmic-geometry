...
const TimeGeometry = () => {
  ...
  const t1Color =
    isSynchro(angles.t1, angles.t2) ||
    isSynchro(angles.t1, angles.t3)
      ? '#00ffff'
      : '#e0e7ff';

  return (
    <div className="time-geometry-work">
      <div className="time-geometry-actions">
        <a
          href="/concepts/time-geometry"
          className="time-geometry-concept-link"
        >
          Conceptを見る
        </a>
      </div>
      ...
      <section className="time-geometry">
        ...
        <svg
          ...
          height="300"
          viewBox="0 0 300 300"
          aria-label="3本の時間ベクトルが異なる速度で回転する図"
        >
