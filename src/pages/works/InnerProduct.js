...
export default function TimeGeometry3d() {
  return (
    <div className="inner-product-wrapper">
      <Canvas
        className="inner-product-canvas"
      ...
      >
        ...
        {/* 共鳴可視化（内積） */}
        <ResonanceSphere vecA={[1, 0, 0]} vecB={[0, 1, 0]} colorBase={30} />
        <ResonanceSphere vecA={[0, 1, 0]} vecB={[0, 0, 1]} colorBase={270} />
        <ResonanceSphere vecA={[1, 0, 0]} vecB={[0, 0, 1]} colorBase={120} />
      </Canvas>
    </div>
  );
}
